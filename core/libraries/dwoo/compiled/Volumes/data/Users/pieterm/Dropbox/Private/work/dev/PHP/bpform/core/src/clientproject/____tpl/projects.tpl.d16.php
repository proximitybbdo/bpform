		...
		<div id="projects">
			<div class="content">
				...
				<ul class="projects-list">
					...
					<?php 
$_loop0_data = (isset($this->scope["projectList"]) ? $this->scope["projectList"] : null);
...
/* -- loop start output */
?>
					<li><a href="<?php echo $this->scope["folder_name"];?>"><?php echo $this->scope["folder_name"];?></a> <em><?php echo $this->scope["mod_date"];?></em></li>
					<?php 
/* -- loop end output */
